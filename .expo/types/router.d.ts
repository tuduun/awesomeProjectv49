...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/diet/_layout` | `/diet/_layout` | `/(tabs)/diet/` | `/diet/` | `/(tabs)/diet` | `/(tabs)/diet/styles` | `/diet/styles` | `/(tabs)/goals/_layout` | `/goals/_layout` | `/(tabs)/goals/` | `/goals/` | `/(tabs)/goals` | `/(tabs)/home/_layout` | `/home/_layout` | `/(tabs)/home/` | `/home/` | `/(tabs)/home` | `/+html` | `/modal`;
  // prettier-ignore
